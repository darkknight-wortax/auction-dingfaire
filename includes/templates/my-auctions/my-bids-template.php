    ...
    <div class="container d-flex">
        ...
        <div class="auction-content-area">
            ...
            if (!is_user_logged_in()) {
                ...
                $get_auction_bids = $wpdb->get_results('SELECT DISTINCT `post_id` FROM `'.$table_name.'` WHERE `user_id`=' . $user_id . ' ORDER BY `bidding_datetime` DESC');
                        ...
                        <tbody>
                            ...
                            ?>
                                <tr>
                                    ...
                                    <td><?php if($my_latest_bid){echo $currency.$my_latest_bid;} else{ echo '-';} ?></td>
                                    <td><?php if($current_bid){echo $currency.$current_bid;} else{ echo '-';}  ?></td>
                                </tr>
                            <?php
